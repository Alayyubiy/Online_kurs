...
from functions.enrollments import enroll_user, get_all_enrollments, update_enrollment, delete_enrollment
...
def route_delete_enrollment(ident: int, db: Session = Depends(database),
                            current_user = Depends(get_current_user)):
